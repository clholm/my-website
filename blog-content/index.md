...
## [k8s secrets, metadata, and their visibility](../blog-content/20251201-k8s-secrets-metadata-visibility.md)
...
* 2025/12/27: [k8s secrets, metadata, and their visibility](../blog-content/20251201-k8s-secrets-metadata-visibility.md) { #k8s, #secrets, #featured }
